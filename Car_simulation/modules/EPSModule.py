...
from core.dtc.DTCManager import EPS_DTCManager


class EPS_Module(EPS_DTCManager):
    """
    Elektromos szervokormány szimulációs modul.
    DTC_POOL és DTC_FILE az EPS_DTCManager-ből jön — itt nincs duplikálva.
    """

    def __init__(self, DME, DSC):
        EPS_DTCManager.__init__(self)
